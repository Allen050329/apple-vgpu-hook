    ...
    *prev = Some(now);
    crate::observe::off(format!(
        "engine_delta creates={} allocs={} batch_opens={} batch_joins={} batch_flushes={} \
         ...
         present_capture_reads={} present_capture_read_bytes={} \
         guest_writeback_reads={} guest_writeback_read_bytes={} \
         gpu_stamps={} pipeline_misses={} \
        ...
        d.present_capture_reads,
        d.present_capture_read_bytes,
        d.guest_writeback_reads,
        d.guest_writeback_read_bytes,
        d.gpu_stamps,
        d.pipeline_misses,
        d.shader_misses,
        d.pass_misses,
